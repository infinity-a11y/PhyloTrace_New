# app/view/database_missing_values.R
#
# "Missing Values" interface of the Database menu. UI and backend live here so
...
ui <- function(id) {
  ...
  as_fill_carrier(
    div(
      div(class = "db-page_header", h2("Missing Values")),
...
server <- function(
  ...
  moduleServer(id, function(input, output, session) {
    ...
    # No local reactive state to clear yet; placeholder for future missing-values UI.
